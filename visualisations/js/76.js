...
function updatePieCharts(state , stateData) {
    d3.csv("../../dataset/constituencies.csv").then(function (data) {
      ...
      // Render Pie Charts
      renderPieChart("#piechart176", pieData1, 300 , "Reservation of Constituencies");  // Assuming a renderPieChart function exists
      renderPieChart("#piechart276", pieData2, 300 , "Constituencies won in 2019 elections");  // Assuming a renderPieChart function exists
    });
  }
